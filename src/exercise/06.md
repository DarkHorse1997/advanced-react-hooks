...
- Used to provide labels to custom hooks in React devtools.

* We can pass in the current state and display that to differentiate our custom
  hook calls.
* It also takes in a string formatter function as a second argument.
